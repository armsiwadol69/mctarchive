                            ...
                            <div class="card-body">
                                ...
                                <form name="settingWebsite" method="POST" action="savesetting.php">
                                    <div class="form-group mt-2">
                                        ...
                                        <input type="text" class="form-control" name="shortNameEng" value="<?php echo $shortNameEng;?>" require>
                                    </div>
                                    <div class="form-group mt-2">
                                        <label for="websiteName">ชื่อเว็บไซต์</label>
                                        <input type="text" class="form-control" name="websiteName" value="<?php echo $v_websiteName;?>" require>
                                    </div>
                                    <div class="form-group mt-2">
                                        <label for="subName">คำอธิบายเพิ่มเติม</label>
                                        <input type="text" class="form-control" name="subName" value="<?php echo $v_subName;?>" require>
                                    </div>
                                    <div class="form-group mt-2">
                                        <label for="email">อีเมลล์</label>
                                        <input type="email" class="form-control" name="email" value="<?php echo $v_email;?>" require>
                                    </div>
                                    <div class="form-group mt-2">
                                        <label for="telNumber">เบอร์โทร</label>
                                        <input type="tel" class="form-control" name="telNumber" value="<?php echo $v_telNumber;?>" require>
                                    </div>
