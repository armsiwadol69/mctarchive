...
if (isset($_POST["year"]) == 0 OR empty($_POST["year"]) == 1) {
  Header("Location: ".$_SESSION["lastPageToReturn"]."?add_year=2");
  exit(0);
}
...
if ($query == 1) {
  Header("Location: ".$_SESSION["lastPageToReturn"]."?add_year=1");
}elseif ($query == 0) {
  Header("Location: ".$_SESSION["lastPageToReturn"]."?add_year=0");
}
 ?>
