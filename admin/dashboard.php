        ...
        <div class="row">
            <div class="col-12">
                <div class="jumbotron jumbotron_admin mainjum mainvector mt-4">
                    ...
                    <h5>ยินดีตอนรับคุณ <?php echo $_SESSION["name"]; ?> เข้าสู่ระบบเมื่อ
            ...
            <div class="col-12">
                <div class="alert alert-info w-100 shadow-sm" role="alert">
                    หากพบปัญหาในการใช้งานหรือมีข้อสงสัยติดต่อ 091-003-6260 | Line: armsiwadol2543
                    <hr>
                    โปรดทราบ : ฟีเจอร์ แก้ไขข้อมูล ไม่สามารถใช้งานได้ชั่วคราว
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive px-1 py-1">
                            <table
                                ...
                                data-aos="fade-up" data-aos-duration="500" id="table_1">
                                <thead>
                                    <tr>
...
while ($all = mysqli_fetch_array($result_all)) {
    ...
    echo "<td>" . '<a type="button" class="btn btn-secondary disabled' . $permission . '" href="edit_topic.php?id=' . $all["system_id"] . '"><i class="bi bi-pencil-square"></i></a>' . "</td> ";
                            ...
                            <div class="btn-toolbar w-100" style="justify-content: center; display: flex;"
                                ...
                                <div class="btn-group my-2 shadow-sm" role="group" aria-label="First group">
                                    <a class="btn btn-dark"
                                        href="?page=1<?php echo "&page_pre=" . $page_pre_default; ?>#displayed">หน้าแรก</a>
...
?>
                                    ...
                                    <a class="btn btn-dark <?php if ($page_default >= $total_pages) {echo "disabled";}?>"
                                        href="?page=<?php echo $total_pages; ?><?php echo "&page_pre=" . $page_pre_default; ?>#displayed">หน้าสุดท้าย</a>
            ...
            <div class="col-12 mt-4">
                <div class="card" id="preview" name="preview">
                    ...
                    <div class="card-body">
                        <div class="table-responsive px-1 py-1">
                            <table
                                class="table text-dark table-hover table-striped mx-auto my-auto w-100 text-center align-middle"
                                data-aos="fade-up" data-aos-duration="500" id="table_2">
                                <thead>
                                    <tr>
                                        <td>ID</td>
                                        <td style="width:50%;">หัวข้อ</td>
...
while ($all = mysqli_fetch_array($result_all_wait)) {
    ...
    echo "<td>" . '<a type="button" class="btn btn-secondary" href="edit_topic.php?preview=1&id=' . $all["system_id"] . '"><i class="bi bi-pencil-square"></i></a>' . "</td> ";
...
?>
                        ...
                        <div class="mt-3 w-100" hidden>
                            ...
                            <div class="btn-toolbar w-100" style="justify-content: center; display: flex;"
                                ...
                                <div class="btn-group my-2 shadow-sm" role="group" aria-label="First group">
                                    <a class="btn btn-dark"
                                        href="<?php echo "?page=" . $page_default; ?>&page_pre=1#preview">หน้าแรก</a>
...
?>
                                    ...
                                    <a class="btn btn-dark <?php if ($page_pre_default >= $total_pages_pre) {echo 'disabled';}?>"
                                        href="<?php echo "?page=" . $page_default; ?>&page_pre=<?php echo $total_pages_pre; ?>#preview">หน้าสุดท้าย</a>
