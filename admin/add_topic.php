        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="alert alert-info w-100 shadow-sm" role="alert">
                    ...
                    <hr>
                   <h6>ข้อแนะนำ 2 : หากมีไฟล์ผลงานหรือไฟล์ใดๆก็ตาม ในการบันทึกข้อมูลแต่ละครั้งไฟล์ทั้งหมดที่จะอัปโหลดไปด้วย <span class="badge bg-warning text-dark">ห้ามเกิน 24 GB</span> ต่อครั้ง</h6>
                </div>
            </div>
        </div>
