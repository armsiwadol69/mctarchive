...
$conn = mysqli_connect($serverName,$userName,$userPassword,$dbName);
 ...
 <html lang="en" dir="ltr">
   ...
   <h5>ยินดีตอนรับคุณ <?php echo $_SESSION["username"]; ?> เข้าสู่ระบบเมื่อ <?php echo $_SESSION["time"]; ?></h5>
     ...
     ?>
      ...
      echo '<option>'.$row3["year"].'</option>';
         ...
         <div class="row">
           ...
           <div class="col-lg-4 col-md-12 col-sm-12 mt-1" <?php if ($_SESSION["level"] !== "ADMIN") {echo "hidden";} ?> >
